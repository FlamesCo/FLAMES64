...
while running:
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:
            if event.key == pygame.K_SPACE:
                # Space key pressed, proceed to start the game
    ...
    m_box_rect = pygame.Rect(checkered_rect.left + 60, checkered_rect.centery - 50, 100, 100)
    l_box_rect = pygame.Rect(checkered_rect.right - 160, checkered_rect.centery - 50, 100, 100)
